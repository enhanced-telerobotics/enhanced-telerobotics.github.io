...
<div class="medium-4 columns b30 profile-element">
	<img src="/images/profiles/kyleG.jpg" alt="">
        <!--img src="{{ site.urlimg }}kyleG.jpg" alt=""-->
        <p><a href="">Kyle Golobish</a>
	<br>
	<i>Undergraduate Rotator</i> <br>
...
<style>
/* General styling for team photos */
.profile-element img {
    width: 100%; /* Makes the image fill the container width */
    aspect-ratio: 4 / 5; /* Ensures a 1:1 (square) aspect ratio */
    object-fit: cover; /* Ensures the image fills the container while maintaining aspect ratio */
    overflow: hidden; /* Ensures cropped parts are not visible */
}
</style>